...
#save our model
model.save('100_epochs_SISO_NTHU_ResNet50.h5')
...
plt.legend()
#plt.show()
plt.savefig('100_epochs_loss_SISO_NTHU_ResNet50')
...
plt.legend()
#plt.show()
plt.savefig('100_epochs_acc_SISO_NTHU_ResNet50')

#save the history of our model
hist_df = pd.DataFrame(r.history) 
hist_csv_file = 'history_100epochs_SISO_NTHU_ResNet50.csv'
